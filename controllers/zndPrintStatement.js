    ...
    {   var items, ideez, bankData, employees, companies, accountLedgerNames, paymentTypesList;
        ...
        {   req.params.newform          = false;
		        ...
		        let retVal                  = await runAugments(items);
		      	res.render('zndPrintStatements',{ items:items ,ideez:ideez,bankData:bankData, employees:employees, companies:companies, accountLedgerNames:accountLedgerNames,  bookkeepingLedgerNames:bookkeepingLedgerNames,paymentTypesList:paymentTypesList });
		    }
		    else
		    {   req.params.newform         = true
		    	  ...
		    	  bookkeepingLedgerNames     = await zndBookKeepersLedgers.find().distinct('bkLedgerLabel')
		    	  paymentTypesList           = await paymentCatagories.find().distinct('paymentCatagoryName')
		    	  res.render('zndPrintStatements',{  employees:employees, companies:companies, accountLedgerNames:accountLedgerNames, bookkeepingLedgerNames:bookkeepingLedgerNames, paymentTypesList:paymentTypesList });
		    }
