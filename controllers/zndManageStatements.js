...
const {statementTemplate}	             = require( '../services/generic' );
const {outputDir}                      = require( '../services/generic' );
const {wordPath}                       = require( '../services/generic' );
const {WordOptions}                    = require( '../services/generic' );
...
{   try
    {   let emailAccount, accountLedgerNames, i;
...
{   try
    {   let emailAccount, accountName, values, retVal;
...
{   let record, mailEvidence,result ;
...
{   let retVal,  mailEvidence, result;
    setRecord( record );
...
{   try
	  {   let image, docPath, listURN, returnURN, result;
