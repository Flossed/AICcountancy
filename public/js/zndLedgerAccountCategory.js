...
{   document.getElementById("ledgerLabel").value  = document.getElementById("ledgerAccountNameID").textContent + '_'+ document.getElementById("ledgerAccountName").textContent
    formulierActie('updateRecord');
}
...
{   var  docActie=document.getElementById("actie").textContent;  
    ...
    document.getElementById("entreeForm").submit();    
}  
