        ...
        {   let rowReference            = "";
            ...
            {   
                ...
                {   let cell            = row.insertCell();
                    ...
                    let rowReference    = "/zndStatements/"+content;
                    ...
                    {   case "compagnyID"         :   cell.appendChild( textNode );
                        ...
                        case "ID"                 :   text            =  document.createTextNode( counter++ );
                                                      ...
                                                      ROWID = aElement;                                                      
                                                      break;
                        case "documentName"       :   let textNoder        =  document.createTextNode( content );
                                                      aElement.appendChild( textNoder );
                                                      
                                                      aElement.setAttribute( "href",ROWID.href );
                                                      console.log('AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAlement',ROWID , aElement)
                                                      cell.appendChild( aElement );
                                                      break;
                        default                   :   if ( amountElements.includes( key ) )
                                                      {   let taxt = document.createTextNode( content.toLocaleString( "nl-NL", options ) );
...
function contextualizeAccounts ( rows,ledgerAccounts )
{
   ...
   try
   {
      ...
      var dashledgerAccounts, option, ledgerAccountList, j;
      ...
      if ( typeof rows[rows.length-1].CREDEB  !== "undefined" )
      {
         ...
         let dashledgerSet               = document.getElementById( "dashledgerAccounts" );
...
function initTable ( msg,queryObj )
{
   ...
   try
   {
      ...
      let dashledgerAccounts          = document.getElementById( "dashledgerAccounts" );
...
function refreshPage ()
{
   ...
   var dashledgerAccounts               = document.getElementById( "dashledgerAccounts" ).value;
